            ...
            <div className="details-section">
              ...
              <div className="color-selection">
                ...
                <div className="color-options">
                  <button className={`color-button1 ${selectedColor === 'white' ? 'selected' : ''}`} onClick={() => setSelectedColor('white')}></button>
                  <button className={`color-button2 ${selectedColor === 'black' ? 'selected' : ''}`} onClick={() => setSelectedColor('black')}></button>
                </div>
              </div>
              ...
              <div><input className="txtcd" type="text" value="" id="te" />
                <button className="check-delivery">Check delivery</button></div>
              <div><button className="add-to-cart">ADD TO CART</button> <FaRegHeart className="heart" size={25} color={heartColor} onClick={handleClick} /></div>
